...
def apply(armature, mats):
    ...
    # Facial planes are compact and slightly higher, matching the reference's
    # straight brow, narrow eyes, small nose and defined mouth without masking
    # the coherent source head underneath.
