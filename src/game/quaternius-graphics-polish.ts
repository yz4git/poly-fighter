...
export const QUATERNIUS_GRAPHICS_POLISH_ID = "QUATERNIUS_HERO_KIT_V3_FULL_ARMOR";
  ...
  const specs: FollowerSpec[] = [
    {
      ...
      boneNames: ["Head", "head"],
      geometry: new THREE.IcosahedronGeometry(0.084, 1),
      material: hair,
      offset: [0, 0.054, 0.008],
      scale: [0.80, 0.60, 0.88],
    },
    {
      name: "ubc-kairo-hair-crest",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.052, 0.078, 0.042, 0.007),
      material: hair,
      offset: [0.004, 0.088, -0.028],
      rotation: [0.72, -0.05, 0.06],
    },
    {
      name: "ubc-kairo-fringe-left",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.026, 0.066, 0.024, -0.005),
      material: hair,
      offset: [-0.025, 0.068, 0.054],
      rotation: [-0.12, 0.04, -0.20],
    },
    {
      name: "ubc-kairo-fringe-right",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.024, 0.061, 0.024, 0.004),
      material: hair,
      offset: [0.024, 0.069, 0.053],
      rotation: [-0.12, -0.04, 0.18],
    },
    {
      name: "ubc-kairo-torso-core",
      boneNames: ["spine_03", "spine_02", "spine_01"],
      geometry: new THREE.BoxGeometry(0.132, 0.112, 0.026),
      material: dark,
      offset: [0, -0.016, 0.061],
      scale: [0.96, 1.0, 0.92],
    },
    {
      name: "ubc-kairo-forge-chest-left",
      boneNames: ["spine_03", "spine_02", "spine_01"],
      geometry: bladeGeometry(0.066, 0.105, 0.027, -0.012),
      material: primary,
      offset: [-0.038, -0.016, 0.078],
      rotation: [-0.04, 0, -0.15],
    },
    {
      name: "ubc-kairo-forge-chest-right",
      boneNames: ["spine_03", "spine_02", "spine_01"],
      geometry: bladeGeometry(0.063, 0.098, 0.026, 0.011),
      material: accent,
      offset: [0.036, -0.020, 0.078],
    ...
    },
    {
      ...
      geometry: new THREE.CylinderGeometry(0.038, 0.044, 0.102, 6, 1),
      material: primary,
    ...
    },
    {
      ...
      boneNames: ["calf_l"],
      geometry: bladeGeometry(0.074, 0.132, 0.040, 0),
      material: primary,
      offset: [0, -0.064, 0.050],
    },
    {
      name: "ubc-kairo-right-shin-guard",
      boneNames: ["calf_r"],
      geometry: bladeGeometry(0.070, 0.128, 0.038, 0),
      material: accent,
      offset: [0, -0.062, 0.050],
    },
    {
  ...
  const specs: FollowerSpec[] = [
    {
      ...
      boneNames: ["Head", "head"],
      geometry: new THREE.IcosahedronGeometry(0.080, 1),
      material: hair,
      offset: [0, 0.052, 0.006],
      scale: [0.77, 0.59, 0.86],
    },
    {
      name: "ubc-sera-fringe",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.032, 0.074, 0.026, 0.005),
      material: hair,
      offset: [-0.006, 0.072, 0.054],
      rotation: [-0.13, 0.02, -0.10],
    },
    {
      name: "ubc-sera-ponytail-upper",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.032, 0.126, 0.028, 0.004),
      material: hair,
      offset: [0.003, 0.046, -0.088],
      rotation: [0.60, 0.02, 0.02],
    },
    {
      name: "ubc-sera-ponytail-lower",
      boneNames: ["Head", "head"],
      geometry: bladeGeometry(0.027, 0.136, 0.024, -0.003),
      material: hair,
      offset: [0.006, -0.012, -0.128],
      rotation: [0.74, -0.04, -0.04],
    },
    {
      name: "ubc-sera-prism-collar",
      boneNames: ["spine_03", "spine_02", "spine_01"],
      geometry: bladeGeometry(0.122, 0.056, 0.028, 0),
      material: metal,
    ...
    },
    {
      ...
      boneNames: ["lowerarm_l", "forearm_l"],
      geometry: new THREE.CylinderGeometry(0.032, 0.038, 0.094, 6, 1),
      material: primary,
      offset: [0, -0.050, 0.012],
      scale: [1.0, 1.0, 0.84],
    },
    ...
    },
    {
      ...
      boneNames: ["calf_l"],
      geometry: bladeGeometry(0.062, 0.118, 0.034, 0),
      material: primary,
      offset: [0, -0.058, 0.046],
    },
    {
      name: "ubc-sera-right-shin-guard",
      boneNames: ["calf_r"],
      geometry: bladeGeometry(0.060, 0.116, 0.034, 0),
      material: accent,
      offset: [0, -0.057, 0.046],
    },
  ];
  return specs.map((spec) => addBoneFollower(visual, host, spec)).filter((value): value is THREE.Mesh => Boolean(value));
}
