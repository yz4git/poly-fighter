...
test("motion readability audit checks authored kicks at the final active contact frame without legacy IK exaggeration", async () => {
  ...
  assert.match(source, /game\.p1\.isActive\(\) && game\.p1\.moveTick >= authoredContactTick/);
