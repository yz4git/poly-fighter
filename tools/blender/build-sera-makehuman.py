...
def main():
    ...
    # Costume/hair remain deliberately simple overlays for this anatomical-base
    # checkpoint. The important change is replacing primitive anatomy with a
    # coherent CC0 human body before further SERA-specific sculpting.
    ...
    with open(os.path.join(out,'README.txt'),'w') as fp:
        fp.write('SERA prototype uses the CC0 MakeHuman hm08 BODY mesh plus asian-female-young target as its anatomical base. Runtime remains unchanged.\n')
