...
const MOVE_MOTIONS: Readonly<Record<string, MoveMotionSpec>> = {
  ...
  kick: { clip: "NinjaJump_Start", style: "FRONT_KICK", speedScale: 1.0, contactBlend: 0.78 },
  lowKick: { clip: "Slide_Start", style: "LOW_KICK", speedScale: 1.02, contactBlend: 0.82 },
  risingKick: { clip: "NinjaJump_Start", style: "RISING_KICK", speedScale: 0.94, contactBlend: 0.86 },
  dashKick: { clip: "NinjaJump_Start", style: "DASH_KICK", speedScale: 0.9, contactBlend: 0.90 },
