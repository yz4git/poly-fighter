...
test("Quaternius UBC and both animation libraries share all motion target names", async () => {
...
test("Quaternius runtime keeps deterministic canonical contact correction", async () => {
  ...
  assert.match(runtime, /ual2-fight-core\.glb/);
