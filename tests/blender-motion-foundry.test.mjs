...
test("Blender Motion Foundry authors Power with Blender IK and visual-pose bake", async () => {
...
test("Model View exposes Blender-authored clips for A\/B review", async () => {
