...
function buildKairoKit(visual: FighterVisual, host: THREE.Object3D, definition: FighterDefinition): THREE.Mesh[] {
  ...
  const specs: FollowerSpec[] = [
    ...
    {
      name: "ubc-kairo-outfit-left-sleeve",
      boneNames: ["upperarm_l"],
      geometry: panelGeometry(0.055, 0.112, 0.014, 0.88, 1.0),
      material: clothPrimary,
      offset: [0, -0.060, 0.031],
    },
    {
      name: "ubc-kairo-outfit-right-sleeve",
      boneNames: ["upperarm_r"],
      geometry: panelGeometry(0.055, 0.112, 0.014, 0.88, 1.0),
      material: clothPrimary,
      offset: [0, -0.060, 0.031],
    },
...
function buildSeraKit(visual: FighterVisual, host: THREE.Object3D, definition: FighterDefinition): THREE.Mesh[] {
  ...
  const specs: FollowerSpec[] = [
    ...
    {
      name: "ubc-sera-outfit-left-sleeve",
      boneNames: ["upperarm_l"],
      geometry: panelGeometry(0.048, 0.100, 0.012, 0.86, 1.0),
      material: clothPrimary,
      offset: [0, -0.054, 0.028],
    },
    {
      name: "ubc-sera-outfit-right-sleeve",
      boneNames: ["upperarm_r"],
      geometry: panelGeometry(0.048, 0.100, 0.012, 0.86, 1.0),
      material: clothPrimary,
      offset: [0, -0.054, 0.028],
