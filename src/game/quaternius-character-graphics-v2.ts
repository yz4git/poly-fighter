...
function buildSeraV2(visual: FighterVisual, host: THREE.Object3D, definition: FighterDefinition): THREE.Mesh[] {
  ...
  const specs: V2FollowerSpec[] = [
    ...
    {
      name: "ubc-sera-v2-left-forearm-fin",
      boneNames: ["lowerarm_l", "forearm_l"],
      geometry: bladeGeometry(0.022, 0.066, 0.014, -0.006),
      material: accent,
      offset: [-0.025, -0.045, 0.020],
      rotation: [0.10, 0.08, -0.18],
      layer: "ARM",
    },
    {
      name: "ubc-sera-v2-right-forearm-fin",
